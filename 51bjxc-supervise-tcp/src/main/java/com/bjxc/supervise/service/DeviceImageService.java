...
public class DeviceImageService {
	...
	public void updateUrl(int photoNum,Integer deviceId,String url) {
		deviceImageMapper.updateUrl(photoNum,deviceId,url);
	}
	...
	public List<DeviceImage> findByNum(String photoNum, Integer deviceId) {
		return deviceImageMapper.findByNum(photoNum,deviceId);
	}
}
