...
public class TrainingRecordService {
	...
	public Integer getLastTrainingLogCode(String studentNum){
		TrainingRecord lastTrainingLogCode = trainingRecordMapper.getLastTrainingLogCode(studentNum);
		if(lastTrainingLogCode==null){
			return 0;
		}
		return Integer.parseInt(lastTrainingLogCode.getEtrainingNum());
	}
	...
	public void updateSpeedCount(Integer id){
		trainingRecordMapper.updateSpeedCount(id);
	}
}
